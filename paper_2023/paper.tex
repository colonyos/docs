...
Colonies can be used to implement a decentralized, grid-like compute infrastructure for executing EO workloads across diverse platforms. By encapsulating computational EO tasks in Colony processes, interoperability among platforms can be significantly enhanced. Executors could also be used to provision computational resources if needed. For example, automatically provision cloud resources and setup EO software, or deploy workflows at HPC systems to handle high-demand EO workloads. 
